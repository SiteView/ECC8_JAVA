...
//		
	...
	public void buidInfo(Report simpleReport) {
		...
		if (errorCondition==null) {
			INode m_node = simpleReport.getM_node();
			String m_id = m_node.getSvId();
			String monitorNameAndCondition = OfbizCall.getMonitorNameAndCondition(m_id);
			...
			errorCondition = monitorCondition;
		}
//		Iterator itm = dstrs.keySet().iterator();
