						...
						<form method="post" id="login" name="login" action="/ecc/index.jsp">
							<table cellSpacing="0px" cellPadding="0px" class="widthauto">					
								...
								<tr>
									...
									<td ><input onFocus="this.select()" onkeypress="if(event.keyCode==13){document.getElementById('login').submit();}" style="border:1px solid #19598D; width:150px;" name="Password" type=password value="system"/></td>
								</tr>
								<tr>
									<td ></td>
